...
/**
 * List of available currencies for the currency selector.
 * Maps currency codes to their English names.
 */
 ...
 * It contains local state and commits changes to recordDraft with Save button.
 *
 * @remarks
 * Uses local asset state managed by useAssetDispatch hook. Changes are saved to the
 * global RecordDraft instance when the user clicks Save or Delete.
 *
 * @example
 * ```tsx
 * <AssetEdit />
...
/**
 * Saves the asset to the global RecordDraft instance.
 *
 * @param navigate - Navigate function to go back after saving
 * @param assetValues - Current asset state values to save
 * @param assetDispatch - Dispatch function to update asset state
 * @param assetId - Optional existing asset ID (used for edits)
 *
 * @returns Whether the save was successful (navigates back on success)
 *
 * @throws Error if RecordDraft instance is not available
 */
...
/**
 * Gets all asset names for a given institution from the RecordDraft.
 *
 * @param institutionId - The institution ID to get asset names for
 *
 * @returns Array of asset names or undefined if no assets exist
 *
 * @throws Error if RecordDraft instance is not available
 */
...
/**
 * Common props for asset input components.
 *
 * @template Value - The type of the input value
 */
