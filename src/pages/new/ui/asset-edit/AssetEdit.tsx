			...
			<List className="static">
				...
				<div className="relative z-10">
					<NameInput
						...
						autoFocus={typeof assetId !== "string"}
...
function handleAssetSave(
	...
	const id = assetId
		? assetId
		: `${assetValues.institution}.${assetValues.name}`;

	let hasErrors = false;

	if (assetValues.errors)
		for (const errors of Object.values(assetValues.errors)) {
	...
	//   }
	// }
	recordDraft.saveAsset(id, { ...assetValues, isDirty: true });
...
function getInstitutionAssetsNames(institutionId: string) {
	...
	for (const assetId of institutionAssets) {
