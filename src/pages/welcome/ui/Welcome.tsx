...
/**
 * Welcome page for the SavNote application.
 *
 * This is the landing page that displays when the user first opens the app. It allows
 * the user to either create a new savings journal or open an existing one.
 *
 * @remarks
 * - Creates a new journal via the "Create new" button, navigating to /create
 * - Opens an existing journal via the "Open existing" button, navigating to /open
 * - Shows an error message if opening a journal fails
 *
 * @example
 * ```tsx
 * <Welcome />
